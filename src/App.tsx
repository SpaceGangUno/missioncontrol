...
import { Rocket, Calendar, Clock, CalendarDays, User, LogOut, Settings, Menu, X, Loader } from 'lucide-react';
...
export default function App() {
  ...
  const { goals, loading, goalsLoading, dayPlanLoading, addGoal, toggleGoal, updateGoal } = useStore();
